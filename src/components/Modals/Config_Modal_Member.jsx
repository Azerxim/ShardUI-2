...
// (même fonctionnement que Config_Modal_Civilisation_Member et Config_Modal_Civilisation_Member_Edit).
const ROLE_OPTIONS = [
...
export const Config_Modal_Religion_Member = religion.add;
export const Config_Modal_Religion_Member_Edit = religion.edit;
export const Config_Modal_Commerce_Member = commerce.add;
export const Config_Modal_Commerce_Member_Edit = commerce.edit;
