                ...
                <nav className="grid-flow-col gap-4 justify-self-end items-center">
                    ...
                    <div className="dropdown dropdown-top dropdown-start hidden sm:flex tooltip tooltip-left" data-tip="Saison">
                        ...
                        <ul tabIndex="-1" className="dropdown-content menu bg-base-200 rounded-3xl z-1 p-2 m-1 mb-7 shadow-xl flex-col gap-1">
                            ...
                            <li>
                                <a href="https://s2.tetrago.fr/rp" className={`justify-start flex-row gap-1 nowrap pr-5 pl-4 rounded-box rounded-3xl`}>
                                    <span>Saison</span>
                                    <span>2</span>
                                </a>
                            </li>
                            <li>
                                <a href="https://s1.tetrago.fr/" className={`justify-start flex-row gap-1 nowrap pr-5 pl-4 rounded-box rounded-3xl`}>
                                    <span>Saison</span>
                                    <span>1</span>
                                </a>
                            </li>
