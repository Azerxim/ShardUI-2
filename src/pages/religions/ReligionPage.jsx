...
import { religionMemberModal, religionMemberEditModal } from '@/config/modals/member';
import {
    getReligionById,
    getReligions,
    getCivilisations,
...
export default function ReligionPage() {
    ...
    const FctModify = [
        { id: 1, title: "Modifier", icon: "fas fa-pen", class: "bg-base-200 hover:bg-base-300", connected: true, authorisation: auth, function: () => showModal(religionModal, "edit") }
    ];
    ...
    const FctMembers = [
        { id: 1, title: "Ajouter", icon: "fas fa-plus", class: "bg-base-200 hover:bg-base-300", connected: true, authorisation: auth, function: () => showModal(religionMemberModal, "add") }
    ];
                ...
                {sortedMembers.length > 0 ? (
                    sortedMembers.map((member) => (
                        <MemberButton
                            ...
                            member={member}
                            roleColor={color}
                            editConfig={religionMemberEditModal}
        ...
        <>
            ...
            <main className="container mx-auto p-4">
                <div className="flex flex-col items-center justify-center gap-2">
                    ...
                    <DynamicModal config={religionModal} mode="edit" onSubmit={(religion) => { updateReligion(religion) }} onDelete={handleDelete} />
                    <DynamicModal config={religionMemberModal} mode="add" onSubmit={addMember} />
