...
export default function QuartierDetailPage() {
    ...
    const FctModify = [
        ...
        { id: 2, title: "Modifier", icon: "fas fa-pen", class: "bg-base-200 hover:bg-base-300", connected: true, authorisation: auth, function: () => showModal(quartierModal, "edit") }
    ];
        ...
        <>
            ...
            <main className="container mx-auto p-4">
                <div className="flex flex-col items-center justify-center gap-2">
                    ...
                    {auth && quartier ? (
                        <>
                            <DynamicModal config={quartierModal} mode="edit" onSubmit={updateQuartier} onDelete={() => navigate(villeUrl)} />
