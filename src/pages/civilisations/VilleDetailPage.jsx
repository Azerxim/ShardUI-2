...
import VilleReligionAddModal from '@/components/civilisations/VilleReligionAddModal';
...
import { quartierModal } from '@/config/modals/quartier';
import {
    getCivilisationById,
    getCommerces,
    getDimensions,
...
export default function VilleDetailPage() {
    ...
    const FctModify = [
        ...
        { id: 2, title: "Modifier", icon: "fas fa-pen", class: "bg-base-200 hover:bg-base-300", connected: true, authorisation: auth, function: () => showModal(villeModal, "edit") }
    ];
        ...
        <>
            ...
            <main className="container mx-auto p-4">
                <div className="flex flex-col items-center justify-center gap-2">
                    ...
                    {auth && ville ? (
                        <>
                            <DynamicModal config={villeModal} mode="edit" onSubmit={updateVille} onDelete={() => navigate(`/civilisation/${civ_id}`)} />
                            <VilleReligionAddModal id={RELIGION_ADD_MODAL_ID} ville_id={id} ville_religion_list={religions} onSubmit={addReligion} />
                            <DynamicModal config={quartierModal} mode="add" onSubmit={addQuartier} />
                        </>
                    ) : null}
                </div>
            </main>
